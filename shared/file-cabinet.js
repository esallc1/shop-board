...
window.FileCabinet = (function () {
  ...
  const DOCS = [
    ...
    { id: 'mtray',     file: 'messenger-tray.md',   icon: '💬', title: 'Inbox tray — Facebook + calls (advisor board)' },
    { id: 'icalls',    file: 'inbox-calls.md',      icon: '📞', title: 'Incoming calls in the Inbox tray' },
    { id: 'dpad',      file: 'desk-pad.md',         icon: '📝', title: 'Desk pad + bottom drawer (advisor board)' },
    { id: 'wboard',    file: 'whiteboard.md',       icon: '📋', title: 'Whiteboard (advisor board, shared)' },
