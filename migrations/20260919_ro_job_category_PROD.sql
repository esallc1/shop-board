-- ============================================================================
-- Job category on the RO — PROD run (hygemiszxwmyrkmhbjub / www + board).
-- The sandbox has its own file: 20260919_ro_job_category_SANDBOX.sql
...
--
-- SELF-GUARDING (staging-db.md §8.2/§8.3): the block refuses to run unless app_env says PROD. It cannot touch the sandbox.
