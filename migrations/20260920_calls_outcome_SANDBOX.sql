...
-- SANDBOX run (efhmefpaijjncwgbvwki / test.leetransmissionshop.com).
-- -- Prod has its own file: 20260920_calls_outcome_PROD.sql
...
-- or says PROD. Safe to re-run (add column if not exists; CHECK/index added only if missing).
-- ============================================================================
