...
| Cost & Profit (Cockpit + Build Sheet) | `cost-profit.md` | `shop_settings.feature_cost_profit`, `shared/build-sheet.js`, `shared/board-settings.js` (`renderUnitsEditor`/`renderRebuildUnits`), `owner-board.html`, `bookkeeping-board.html` |
