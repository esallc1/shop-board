...
| Cost & Profit (Cockpit + Build Sheet) | `cost-profit.md` | `shared/build-sheet.js`, `shared/board-settings.js` (`renderUnitsEditor`/`renderRebuildUnits`), `owner-board.html`, `bookkeeping-board.html` (no feature switch; `shop_settings.feature_cost_profit` dormant) |
